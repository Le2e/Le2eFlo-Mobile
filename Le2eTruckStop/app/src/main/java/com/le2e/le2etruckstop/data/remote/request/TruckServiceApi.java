...
public interface TruckServiceApi {
    ...
    Observable<StationsResponse> getStations(@SuppressWarnings("SameParameterValue") @Path("version") String version, @Path("radius") String radius, @Body StationBody body);
}
